...
def checkKeyDownEvents(event, aiSettings, screen, stats, sb, playButton, ship, aliens, bullets):
#Respond to keypresses and mouse events
	if event.key == pygame.K_RIGHT:
		...
		startGame(aiSettings, stats, screen, sb, ship, aliens, bullets)
...
def check_events(aiSettings, screen, stats, sb, playButton, ship, aliens, bullets):
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			sys.exit()
		elif event.type == pygame.KEYDOWN:
			checkKeyDownEvents(event, aiSettings, screen, stats, sb, playButton, ship, aliens, bullets)
		elif event.type == pygame.KEYUP:
			checkKeyUpEvents(event,ship)
		elif event.type == pygame.MOUSEBUTTONDOWN:
			mouse_x, mouse_y = pygame.mouse.get_pos()
			checkPlayButton(aiSettings, screen, stats, sb, playButton, ship, aliens, bullets, mouse_x, mouse_y)
		
def startGame(aiSettings, stats, screen, sb, ship, aliens, bullets):
	stats.resetStats()
...
def checkPlayButton(aiSettings, screen, stats, sb, playButton, ship, aliens, bullets, mouse_x, mouse_y):
	buttonClicked = playButton.rect.collidepoint(mouse_x,mouse_y)
	if buttonClicked and not stats.game_active:	
		startGame(aiSettings, stats, screen, sb, ship, aliens, bullets)
		
def update_screen(aiSettings, screen, stats, sb, ship, aliens, bullets, playButton):
	#Redraws screen
...
#Use a copy function since it is not good idea to take things from a loop
	...
	checkCollision(aiSettings, screen, stats, sb, ship, aliens, bullets)
